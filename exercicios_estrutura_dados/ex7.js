// ## Pilha de Pratos Simule uma pilha de pratos em uma cozinha: 
// só é possível colocar um prato no topo (`empilhar`) e só é possível retirar
//  o prato do topo (`desempilhar`). Tente remover um prato de uma pilha vazia 
// e trate esse erro.
