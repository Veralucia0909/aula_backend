...
export type StorageHash =
  StorageHashBase<'b210fafd183e2d5b3d5a35e81f38b1d8f3df2a13e0b7c4daeedf8eee5ffd73f6'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly User: {
      ...
      readonly passaword: CodecTypes['pg/text@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly User: {
      ...
      readonly passaword: CodecTypes['pg/text@1']['input'];
          ...
          readonly User: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly passaword: { readonly column: 'passaword' };
